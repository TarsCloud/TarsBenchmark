...
namespace bm
{
    ...
    inline string etos(const BMErrCode & e)
    {
        switch(e)
        {
            case BM_SERVER_ERR_PARAM: return "BM_SERVER_ERR_PARAM";
            case BM_ADMIN_ERR_NOTFIND: return "BM_ADMIN_ERR_NOTFIND";
            case BM_ADMIN_ERR_RUNNING: return "BM_ADMIN_ERR_RUNNING";
            case BM_ADMIN_ERR_STARTUP: return "BM_ADMIN_ERR_STARTUP";
            case BM_ADMIN_ERR_SHUTDOWN: return "BM_ADMIN_ERR_SHUTDOWN";
            case BM_ADMIN_ERR_ENCODE: return "BM_ADMIN_ERR_ENCODE";
            case BM_ADMIN_ERR_DECODE: return "BM_ADMIN_ERR_DECODE";
            case BM_ADMIN_ERR_SOCKET: return "BM_ADMIN_ERR_SOCKET";
            case BM_ADMIN_ERR_TASK: return "BM_ADMIN_ERR_TASK";
            case BM_ADMIN_ERR_PROTO: return "BM_ADMIN_ERR_PROTO";
            ...
            case BM_NODE_ERR_CONNECTION: return "BM_NODE_ERR_CONNECTION";
            case BM_NODE_ERR_ENDPOINT: return "BM_NODE_ERR_ENDPOINT";
            case BM_NODE_ERR_RPCCALL: return "BM_NODE_ERR_RPCCALL";
            default: return "";
        }
    }
    inline int stoe(const string & s, BMErrCode & e)
    {
        if(s == "BM_SERVER_ERR_PARAM")  { e=BM_SERVER_ERR_PARAM; return 0;}
        if(s == "BM_ADMIN_ERR_NOTFIND")  { e=BM_ADMIN_ERR_NOTFIND; return 0;}
        if(s == "BM_ADMIN_ERR_RUNNING")  { e=BM_ADMIN_ERR_RUNNING; return 0;}
        if(s == "BM_ADMIN_ERR_STARTUP")  { e=BM_ADMIN_ERR_STARTUP; return 0;}
        if(s == "BM_ADMIN_ERR_SHUTDOWN")  { e=BM_ADMIN_ERR_SHUTDOWN; return 0;}
        if(s == "BM_ADMIN_ERR_ENCODE")  { e=BM_ADMIN_ERR_ENCODE; return 0;}
        if(s == "BM_ADMIN_ERR_DECODE")  { e=BM_ADMIN_ERR_DECODE; return 0;}
        if(s == "BM_ADMIN_ERR_SOCKET")  { e=BM_ADMIN_ERR_SOCKET; return 0;}
        if(s == "BM_ADMIN_ERR_TASK")  { e=BM_ADMIN_ERR_TASK; return 0;}
        if(s == "BM_ADMIN_ERR_PROTO")  { e=BM_ADMIN_ERR_PROTO; return 0;}
        ...
        if(s == "BM_NODE_ERR_CONNECTION")  { e=BM_NODE_ERR_CONNECTION; return 0;}
        if(s == "BM_NODE_ERR_ENDPOINT")  { e=BM_NODE_ERR_ENDPOINT; return 0;}
        if(s == "BM_NODE_ERR_RPCCALL")  { e=BM_NODE_ERR_RPCCALL; return 0;}
